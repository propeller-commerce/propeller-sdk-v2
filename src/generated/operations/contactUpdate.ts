...
mutation contactUpdate(\$id: Int!, \$input: UpdateContactInput!, \$contactAttributesInput: AttributeResultSearchInput, \$contactCompaniesSearchInput: ContactCompaniesSearchInput, \$contactPAConfigInput: ContactPurchaseAuthorizationConfigSearchInput, \$companyAttributesInput: AttributeResultSearchInput) {
