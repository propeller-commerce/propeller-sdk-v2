...
export const document: string = `fragment CustomerFields on Customer {
  customerId
  addresses {
    ...AddressFields
  }
...
mutation customerUpdate(\$id: Int!, \$input: UpdateCustomerInput!, \$customerAttributesInput: AttributeResultSearchInput) {
