...
export const document: string = `fragment PricesheetResponseFields on PricesheetResponse {
  items {
    ...PricesheetFields
  }
  itemsFound
...
query pricesheetsEffective(\$input: PricesheetsEffectiveInput!, \$contactAttributesInput: AttributeResultSearchInput, \$contactCompaniesSearchInput: ContactCompaniesSearchInput, \$contactPAConfigInput: ContactPurchaseAuthorizationConfigSearchInput, \$companyAttributesInput: AttributeResultSearchInput, \$customerAttributesInput: AttributeResultSearchInput, \$contactSearchArguments: ContactSearchArguments) {
