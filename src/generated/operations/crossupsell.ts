...
query crossupsell(\$id: String!, \$priceCalculateProductInput: PriceCalculateProductInput, \$imageSearchFilters: MediaImageProductSearchInput, \$language: String, \$imageVariantFilters: TransformationsInput!) {
  crossupsell(id: \$id) {
    ...CrossupsellFields
  }
}`;
