...
mutation clusterOptionMoveBelow(\$clusterOptionUuid: String!, \$targetClusterOptionUuid: String!, \$priceCalculateProductInput: PriceCalculateProductInput, \$imageSearchFilters: MediaImageProductSearchInput, \$language: String, \$imageVariantFilters: TransformationsInput!) {
