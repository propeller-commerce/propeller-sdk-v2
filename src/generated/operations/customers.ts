...
export const document: string = `fragment CustomersResponseFields on CustomersResponse {
  items {
    ...CustomerFields
  }
  itemsFound
...
query customers(\$input: CustomerSearchArguments, \$customerAttributesInput: AttributeResultSearchInput) {
