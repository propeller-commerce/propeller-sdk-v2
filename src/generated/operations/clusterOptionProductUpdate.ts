...
export const document: string = `fragment ProductFields on Product {
  ...IBaseProductFields
  productId
  categoryId
  ...
  categoryRelations {
    ...BaseProductCategoryRelationshipFields
  }
  inventory {
...
fragment BaseProductCategoryRelationshipFields on BaseProductCategoryRelationship {
  uuid
  baseProductUuid
  categoryUuid
  categoryId
...
fragment CategoryRelationshipFields on Category {
  categoryId
  uuid
  sortOrder
  createdAt
...
mutation clusterOptionProductUpdate(\$id: Int!, \$productId: Int!, \$input: UpdateProductInput!, \$attributeResultSearchInput: AttributeResultSearchInput, \$priceCalculateProductInput: PriceCalculateProductInput, \$userBulkPriceProductInput: UserBulkPriceProductInput, \$imageSearchFilters: MediaImageProductSearchInput, \$language: String, \$imageVariantFilters: TransformationsInput!, \$mediaVideoSearchInput: MediaVideoProductSearchInput, \$mediaDocumentSearchInput: MediaDocumentProductSearchInput) {
  clusterOptionProductUpdate(id: \$id, productId: \$productId, input: \$input) {
    ...ProductFields
  }
}`;
