...
export const document: string = `fragment FavoriteListFields on FavoriteList {
  id
  name
  companyId
  contactId
...
query favoriteList(\$id: String!, \$language: String, \$priceCalculateProductInput: PriceCalculateProductInput, \$imageSearchFilters: MediaImageProductSearchInput, \$imageVariantFilters: TransformationsInput!, \$attributeResultSearchInput: AttributeResultSearchInput) {
  favoriteList(id: \$id) {
    ...FavoriteListFields
  }
}`;
