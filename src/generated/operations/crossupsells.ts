...
query crossupsells(\$input: CrossupsellSearchInput, \$language: String, \$imageSearchFilters: MediaImageProductSearchInput, \$imageVariantFilters: TransformationsInput!, \$priceCalculateProductInput: PriceCalculateProductInput!, \$attributeResultSearchInput: AttributeResultSearchInput) {
