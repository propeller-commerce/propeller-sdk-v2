...
mutation pricesheetUpdate(\$id: String!, \$input: PricesheetUpdateInput!, \$contactAttributesInput: AttributeResultSearchInput, \$contactCompaniesSearchInput: ContactCompaniesSearchInput, \$contactPAConfigInput: ContactPurchaseAuthorizationConfigSearchInput, \$companyAttributesInput: AttributeResultSearchInput, \$customerAttributesInput: AttributeResultSearchInput, \$contactSearchArguments: ContactSearchArguments) {
