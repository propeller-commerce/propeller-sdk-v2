...
mutation crossupsellCreate(\$input: CrossupsellCreateInput!, \$priceCalculateProductInput: PriceCalculateProductInput, \$imageSearchFilters: MediaImageProductSearchInput, \$language: String, \$imageVariantFilters: TransformationsInput!, \$attributeResultSearchInput: AttributeResultSearchInput) {
