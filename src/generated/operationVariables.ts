...
/**
 * Variables for the `agentConversationCreate` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface AgentConversationCreateVariables {
  input: AgentConversationCreateInput;
}

/**
 * Variables for the `agentCreate` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface AgentCreateVariables {
  input: AgentCreateInput;
}

/**
 * Variables for the `agentDelete` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface AgentDeleteVariables {
  id: string;
}

/**
 * Variables for the `agentMessageCreate` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface AgentMessageCreateVariables {
  input: AgentMessageCreateInput;
}

/**
 * Variables for the `agents` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface AgentsVariables {
  input?: AgentSearchInput;
}

/**
 * Variables for the `agentUpdate` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface AgentUpdateVariables {
  id: string;
  input: AgentUpdateInput;
}

/**
 * Variables for the `agent` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
...
/**
 * Variables for the `baseProductCategoryMoveAboveByUuids` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface BaseProductCategoryMoveAboveByUuidsVariables {
  categoryUuid: string;
  productUuid: string;
...
/**
 * Variables for the `baseProductCategoryMoveAbove` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface BaseProductCategoryMoveAboveVariables {
  relationshipUuid: string;
  targetRelationshipUuid: string;
}

/**
 * Variables for the `baseProductCategoryMoveBelowByUuids` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface BaseProductCategoryMoveBelowByUuidsVariables {
  categoryUuid: string;
  productUuid: string;
  targetProductUuid: string;
}
...
/**
 * Variables for the `baseProductCategoryMoveBelow` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface BaseProductCategoryMoveBelowVariables {
  relationshipUuid: string;
  targetRelationshipUuid: string;
}

/**
 * Variables for the `baseProductCategoryMoveToBottomByUuids` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface BaseProductCategoryMoveToBottomByUuidsVariables {
  categoryUuid: string;
  productUuid: string;
}

/**
 * Variables for the `baseProductCategoryMoveToBottom` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface BaseProductCategoryMoveToBottomVariables {
  relationshipUuid: string;
}

/**
 * Variables for the `baseProductCategoryMoveToTopByUuids` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface BaseProductCategoryMoveToTopByUuidsVariables {
  categoryUuid: string;
  productUuid: string;
}

/**
 * Variables for the `baseProductCategoryMoveToTop` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface BaseProductCategoryMoveToTopVariables {
  relationshipUuid: string;
}

/**
 * Variables for the `baseProducts` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface BaseProductsVariables {
...
/**
 * Variables for the `categoryBySlug` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly,
 * EXCEPT `imageVariantFilters`: the operation
 * declares this non-null but the SDK supplies a default when
...
/**
 * Variables for the `categoryBySource` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly,
 * EXCEPT `imageVariantFilters`: the operation
 * declares this non-null but the SDK supplies a default when
 * omitted (findings #4/#8), so it is surfaced as optional here.
 */
export interface CategoryBySourceVariables {
  source: SourceInput;
  hidden?: YesNo;
  categoryProductSearchInput?: CategoryProductSearchInput;
  language?: string;
...
/**
 * Variables for the `categoryChildren` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly,
 * EXCEPT `imageVariantFilters`: the operation
 * declares this non-null but the SDK supplies a default when
 * omitted (findings #4/#8), so it is surfaced as optional here.
 */
export interface CategoryChildrenVariables {
  categoryId: number;
  categoryProductSearchInput?: CategoryProductSearchInput;
  language?: string;
  filterAvailableAttributeInput?: FilterAvailableAttributeInput;
...
/**
 * Variables for the `categoryHierarchy` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly,
 * EXCEPT `imageVariantFilters`: the operation
 * declares this non-null but the SDK supplies a default when
 * omitted (findings #4/#8), so it is surfaced as optional here.
 */
export interface CategoryHierarchyVariables {
  categoryId: number;
  categoryProductSearchInput?: CategoryProductSearchInput;
  language?: string;
  filterAvailableAttributeInput?: FilterAvailableAttributeInput;
...
/**
 * Variables for the `categoryMoveAbove` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly,
 * EXCEPT `imageVariantFilters`: the operation
 * declares this non-null but the SDK supplies a default when
 * omitted (findings #4/#8), so it is surfaced as optional here.
 */
export interface CategoryMoveAboveVariables {
  categoryUuid: string;
...
/**
 * Variables for the `categoryMoveBelow` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly,
 * EXCEPT `imageVariantFilters`: the operation
 * declares this non-null but the SDK supplies a default when
 * omitted (findings #4/#8), so it is surfaced as optional here.
 */
export interface CategoryMoveBelowVariables {
  categoryUuid: string;
  targetCategoryUuid: string;
  categoryProductSearchInput?: CategoryProductSearchInput;
  language?: string;
...
/**
 * Variables for the `clusterAddToCategory` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ClusterAddToCategoryVariables {
  clusterId: number;
  categoryId: number;
  sortOrder?: number;
  makeDefault: boolean;
...
/**
 * Variables for the `clusterAssignProduct` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly,
 * EXCEPT `imageVariantFilters`: the operation
 * declares this non-null but the SDK supplies a default when
 * omitted (findings #4/#8), so it is surfaced as optional here.
 */
export interface ClusterAssignProductVariables {
  clusterId: number;
  productId: number;
  language?: string;
  attributeResultSearchInput?: AttributeResultSearchInput;
...
/**
 * Variables for the `clusterCategoryMoveAbove` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ClusterCategoryMoveAboveVariables {
  relationshipUuid: string;
  targetRelationshipUuid: string;
}

/**
 * Variables for the `clusterCategoryMoveBelow` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ClusterCategoryMoveBelowVariables {
  relationshipUuid: string;
  targetRelationshipUuid: string;
}
...
/**
 * Variables for the `clusterConfigSettingCreate` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ClusterConfigSettingCreateVariables {
  configUuid: string;
  input: ClusterConfigSettingCreateInput;
}

/**
 * Variables for the `clusterConfigSettingDelete` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ClusterConfigSettingDeleteVariables {
  uuid: string;
}

/**
 * Variables for the `clusterConfigSettingUpdate` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ClusterConfigSettingUpdateVariables {
  uuid: string;
  input: ClusterConfigSettingUpdateInput;
}

/**
 * Variables for the `clusterConfigSetting` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ClusterConfigSettingVariables {
  uuid: string;
}

/**
 * Variables for the `clusterConfigsPaginated` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ClusterConfigsPaginatedVariables {
  input: ClusterConfigSearchInput;
}
...
/**
 * Variables for the `clusterConfigUpdate` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ClusterConfigUpdateVariables {
...
/**
 * Variables for the `clusterOptionAssignProducts` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly,
 * EXCEPT `imageVariantFilters`: the operation
 * declares this non-null but the SDK supplies a default when
 * omitted (findings #4/#8), so it is surfaced as optional here.
 */
export interface ClusterOptionAssignProductsVariables {
  uuid: string;
  productIds: number[];
  priceCalculateProductInput?: PriceCalculateProductInput;
  imageSearchFilters?: MediaImageProductSearchInput;
...
/**
 * Variables for the `clusterOptionMoveAbove` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly,
 * EXCEPT `imageVariantFilters`: the operation
 * declares this non-null but the SDK supplies a default when
 * omitted (findings #4/#8), so it is surfaced as optional here.
 */
export interface ClusterOptionMoveAboveVariables {
...
/**
 * Variables for the `clusterOptionMoveBelow` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly,
 * EXCEPT `imageVariantFilters`: the operation
 * declares this non-null but the SDK supplies a default when
 * omitted (findings #4/#8), so it is surfaced as optional here.
 */
export interface ClusterOptionMoveBelowVariables {
  clusterOptionUuid: string;
  targetClusterOptionUuid: string;
  priceCalculateProductInput?: PriceCalculateProductInput;
  imageSearchFilters?: MediaImageProductSearchInput;
...
/**
 * Variables for the `clusterOptionProductCreate` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly,
 * EXCEPT `imageVariantFilters`: the operation
 * declares this non-null but the SDK supplies a default when
 * omitted (findings #4/#8), so it is surfaced as optional here.
 */
export interface ClusterOptionProductCreateVariables {
  id: number;
...
/**
 * Variables for the `clusterOptionProductDelete` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ClusterOptionProductDeleteVariables {
  id: number;
  productId: number;
}

/**
 * Variables for the `clusterOptionProductUpdate` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly,
 * EXCEPT `imageVariantFilters`: the operation
 * declares this non-null but the SDK supplies a default when
 * omitted (findings #4/#8), so it is surfaced as optional here.
 */
export interface ClusterOptionProductUpdateVariables {
  id: number;
  productId: number;
...
/**
 * Variables for the `clusterOptionRemoveProducts` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly,
 * EXCEPT `imageVariantFilters`: the operation
 * declares this non-null but the SDK supplies a default when
 * omitted (findings #4/#8), so it is surfaced as optional here.
 */
export interface ClusterOptionRemoveProductsVariables {
  uuid: string;
  productIds: number[];
  priceCalculateProductInput?: PriceCalculateProductInput;
  imageSearchFilters?: MediaImageProductSearchInput;
...
/**
 * Variables for the `clusterOptions` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ClusterOptionsVariables {
  input: ClusterOptionPaginatedSearchInput;
}
...
/**
 * Variables for the `clusterOption` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly,
 * EXCEPT `imageVariantFilters`: the operation
 * declares this non-null but the SDK supplies a default when
 * omitted (findings #4/#8), so it is surfaced as optional here.
 */
export interface ClusterOptionVariables {
  uuid: string;
  priceCalculateProductInput?: PriceCalculateProductInput;
  imageSearchFilters?: MediaImageProductSearchInput;
  language?: string;
...
/**
 * Variables for the `clusterRemoveFromCategory` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ClusterRemoveFromCategoryVariables {
  clusterId: number;
  categoryId: number;
}

/**
 * Variables for the `clustersBulkAddToCategory` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ClustersBulkAddToCategoryVariables {
  clusterIds: number[];
  categoryId: number;
...
/**
 * Variables for the `clustersBulkRemoveFromCategory` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ClustersBulkRemoveFromCategoryVariables {
  clusterIds: number[];
  categoryId: number;
}

/**
 * Variables for the `clusterSetDefaultCategory` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly,
 * EXCEPT `imageVariantFilters`: the operation
 * declares this non-null but the SDK supplies a default when
 * omitted (findings #4/#8), so it is surfaced as optional here.
 */
export interface ClusterSetDefaultCategoryVariables {
  clusterId: number;
  categoryId: number;
  language?: string;
  attributeResultSearchInput?: AttributeResultSearchInput;
...
/**
 * Variables for the `clusters` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ClustersVariables {
...
/**
 * Variables for the `clusterUnassignProduct` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly,
 * EXCEPT `imageVariantFilters`: the operation
 * declares this non-null but the SDK supplies a default when
 * omitted (findings #4/#8), so it is surfaced as optional here.
 */
export interface ClusterUnassignProductVariables {
  clusterId: number;
  productId: number;
  language?: string;
  attributeResultSearchInput?: AttributeResultSearchInput;
...
/**
 * Variables for the `gqlApiKeyCreate` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface GqlApiKeyCreateVariables {
  input: GqlApiKeyCreateInput;
}

/**
 * Variables for the `gqlApiKeyDelete` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface GqlApiKeyDeleteVariables {
  id: string;
}

/**
 * Variables for the `gqlApiKeys` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface GqlApiKeysVariables {
  input?: GqlApiKeySearchInput;
}

/**
 * Variables for the `gqlApiKeyUpdate` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface GqlApiKeyUpdateVariables {
  id: string;
  input: GqlApiKeyUpdateInput;
}

/**
 * Variables for the `gqlApiKey` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface GqlApiKeyVariables {
  id: string;
}
...
/**
 * Variables for the `productAddToCategory` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductAddToCategoryVariables {
  productId: number;
  categoryId: number;
  sortOrder?: number;
  makeDefault: boolean;
...
/**
 * Variables for the `productAssignToCluster` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly,
 * EXCEPT `imageVariantFilters`: the operation
 * declares this non-null but the SDK supplies a default when
 * omitted (findings #4/#8), so it is surfaced as optional here.
 */
export interface ProductAssignToClusterVariables {
  productId: number;
  clusterId: number;
  attributeResultSearchInput?: AttributeResultSearchInput;
  priceCalculateProductInput?: PriceCalculateProductInput;
...
/**
 * Variables for the `productCategoryMoveAbove` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductCategoryMoveAboveVariables {
  relationshipUuid: string;
  targetRelationshipUuid: string;
}

/**
 * Variables for the `productCategoryMoveBelow` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductCategoryMoveBelowVariables {
  relationshipUuid: string;
  targetRelationshipUuid: string;
}

/**
 * Variables for the `productCategoryMoveToBottom` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductCategoryMoveToBottomVariables {
  relationshipUuid: string;
}

/**
 * Variables for the `productCategoryMoveToTop` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductCategoryMoveToTopVariables {
  relationshipUuid: string;
}

/**
 * Variables for the `productClusterMoveAbove` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductClusterMoveAboveVariables {
  relationshipUuid: string;
  targetRelationshipUuid: string;
}

/**
 * Variables for the `productClusterMoveBelow` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductClusterMoveBelowVariables {
  relationshipUuid: string;
  targetRelationshipUuid: string;
}

/**
 * Variables for the `productClusterOptionMoveAbove` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductClusterOptionMoveAboveVariables {
  productUuid: string;
  targetProductUuid: string;
}

/**
 * Variables for the `productClusterOptionMoveBelow` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductClusterOptionMoveBelowVariables {
  productUuid: string;
  targetProductUuid: string;
}
...
/**
 * Variables for the `productRemoveFromCategory` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductRemoveFromCategoryVariables {
  productId: number;
  categoryId: number;
}

/**
 * Variables for the `productsBulkAddToCategory` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductsBulkAddToCategoryVariables {
  productIds: number[];
  categoryId: number;
  startingSortOrder: number;
}
...
/**
 * Variables for the `productsBulkRemoveFromCategory` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductsBulkRemoveFromCategoryVariables {
  productIds: number[];
  categoryId: number;
}

/**
 * Variables for the `productSearchBatchMetricsFailedJobs` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductSearchBatchMetricsFailedJobsVariables {
  limit?: number;
  queue?: string;
}

/**
 * Variables for the `productSearchByCategory` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductSearchByCategoryVariables {
  input: ProductSearchByCategoryInput;
}

/**
 * Variables for the `productSearchCategoriesIndex` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductSearchCategoriesIndexVariables {
  input: IndexCategoriesInput;
}

/**
 * Variables for the `productSearchClustersIndex` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductSearchClustersIndexVariables {
  input: IndexClustersInput;
}

/**
 * Variables for the `productSearchFullReindexCancel` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductSearchFullReindexCancelVariables {
  reindexId: string;
}

/**
 * Variables for the `productSearchFullReindexStart` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductSearchFullReindexStartVariables {
  skipNegativeCache?: boolean;
}

/**
 * Variables for the `productSearchProductsIndex` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductSearchProductsIndexVariables {
  input: IndexProductsInput;
}

/**
 * Variables for the `productSearchReindexStatus` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductSearchReindexStatusVariables {
  reindexId: string;
}

/**
 * Variables for the `productSearchSolr` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductSearchSolrVariables {
  input: ProductSearchSearchInput;
}

/**
 * Variables for the `productSetDefaultCategory` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly,
 * EXCEPT `imageVariantFilters`: the operation
 * declares this non-null but the SDK supplies a default when
 * omitted (findings #4/#8), so it is surfaced as optional here.
 */
export interface ProductSetDefaultCategoryVariables {
  productId: number;
  categoryId: number;
  attributeResultSearchInput?: AttributeResultSearchInput;
  priceCalculateProductInput?: PriceCalculateProductInput;
...
/**
 * Variables for the `productsRaw` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface ProductsRawVariables {
...
/**
 * Variables for the `productUnassignFromCluster` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly,
 * EXCEPT `imageVariantFilters`: the operation
 * declares this non-null but the SDK supplies a default when
 * omitted (findings #4/#8), so it is surfaced as optional here.
 */
export interface ProductUnassignFromClusterVariables {
  productId: number;
  attributeResultSearchInput?: AttributeResultSearchInput;
  priceCalculateProductInput?: PriceCalculateProductInput;
  userBulkPriceProductInput?: UserBulkPriceProductInput;
...
/**
 * Variables for the `restApiKeyCreate` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface RestApiKeyCreateVariables {
  input: RestApiKeyCreateInput;
}

/**
 * Variables for the `restApiKeyDelete` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface RestApiKeyDeleteVariables {
  id: string;
}

/**
 * Variables for the `restApiKeys` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface RestApiKeysVariables {
  input?: RestApiKeySearchInput;
}

/**
 * Variables for the `restApiKeyUpdate` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface RestApiKeyUpdateVariables {
  id: string;
  input: RestApiKeyUpdateInput;
}

/**
 * Variables for the `restApiKey` GraphQL operation. Generated from the
 * operation signature — field names and required/optional status mirror
 * the operation's declared variables exactly.
 */
export interface RestApiKeyVariables {
  id: string;
}
