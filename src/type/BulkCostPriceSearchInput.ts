...
import { BulkCostPriceSortInput } from './BulkCostPriceSortInput';
/**
 Input object for BulkCostPriceSearchInput
 */
export interface BulkCostPriceSearchInput {
  ...
  /** Inputs to sort by */
  sortInputs?: BulkCostPriceSortInput[];
}