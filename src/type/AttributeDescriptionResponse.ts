...
export class AttributeDescriptionResponse {
  ...
  private _items: AttributeDescription[];
  ...
  private _end: number;
  /**
   Creates a new instance of AttributeDescriptionResponse
   */
  ...
  /**
   List of items of type AttributeDescription
   */
  get items(): AttributeDescription[] {
    return this._items;
  }
  /**
   List of items of type AttributeDescription
   */
  set items(value: AttributeDescription[]) {
    this._items = value;
  }
  /**
   Total number of items found
