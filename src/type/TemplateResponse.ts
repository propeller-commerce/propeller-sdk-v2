...
/**
 Object class for TemplateResponse
 */
export class TemplateResponse {
  /** List of items of type IBaseTemplate */
  private _items: IBaseTemplate[];
  ...
  private _end: number;
  /**
   Creates a new instance of TemplateResponse
   */
  ...
  /**
   List of items of type IBaseTemplate
   */
  get items(): IBaseTemplate[] {
    return this._items;
  }
  /**
   List of items of type IBaseTemplate
   */
  set items(value: IBaseTemplate[]) {
    this._items = value;
  }
  /**
   Total number of items found
